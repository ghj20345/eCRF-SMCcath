      ...
      modalDialog(
        ...
        fluidRow(
          column(
            ...
            radioButtons(
              ...
              label = "Lesion",
              choices = c(1:3),
              selected = ifelse(is.null(hold$Lesion_culn1), character(0), hold$Lesion_culn1),
              inline = TRUE
            )
          ),
          column(
        ...
        fluidRow(
          ...
          column(
            width = 8,
            conditionalPanel(
              "input.Intervention_culn1 == 'Yes'",
              ns = ns,
              radioButtons(
                ns("Intervention_cnt_culn1"),
                label = "개수",
                choices = c(1:10),
                selected = ifelse(is.null(hold$Intervention_cnt_culn1), character(0), hold$Intervention_cnt_culn1),
                inline = TRUE
              )
            )
          )
          ...
          fluidRow(
            column(
              ...
              radioButtons(
                ...
                selected = ifelse(is.null(hold$Intervention1_treat_culn1), character(0), hold$Intervention1_treat_culn1)
              )
            ),
            column(
              width = 2,
          ...
          fluidRow(
            column(
              ...
              radioButtons(
                ...
                label = "Treatment",
                choices = c("Ballooning" , "Stenting" ),
                selected = ifelse(is.null(hold$Intervention2_treat_culn1), character(0), hold$Intervention2_treat_culn1)
              )
            ),
            column(
              width = 2,
          ...
          fluidRow(
            column(
              ...
              radioButtons(
                ...
                label = "Treatment",
                choices = c("Ballooning" , "Stenting" ),
                selected = ifelse(is.null(hold$Intervention3_treat_culn1), character(0), hold$Intervention3_treat_culn1)
              )
            ),
            column(
              width = 2,
          ...
          fluidRow(
            column(
              ...
              radioButtons(
                ...
                label = "Treatment",
                choices = c("Ballooning" , "Stenting" ),
                selected = ifelse(is.null(hold$Intervention4_treat_culn1), character(0), hold$Intervention4_treat_culn1)
              )
            ),
            column(
              width = 2,
          ...
          fluidRow(
            column(
              ...
              radioButtons(
                ...
                label = "Treatment",
                choices = c("Ballooning" , "Stenting" ),
                selected = ifelse(is.null(hold$Intervention5_treat_culn1), character(0), hold$Intervention5_treat_culn1)
              )
            ),
            column(
              width = 2,
          ...
          fluidRow(
            column(
              ...
              radioButtons(
                ...
                label = "Treatment",
                choices = c("Ballooning" , "Stenting" ),
                selected = ifelse(is.null(hold$Intervention6_treat_culn1), character(0), hold$Intervention6_treat_culn1)
              )
            ),
            column(
              width = 2,
          ...
          fluidRow(
            column(
              ...
              radioButtons(
                ...
                label = "Treatment",
                choices = c("Ballooning" , "Stenting" ),
                selected = ifelse(is.null(hold$Intervention7_treat_culn1), character(0), hold$Intervention7_treat_culn1)
              )
            ),
            column(
              width = 2,
          ...
          fluidRow(
            column(
              ...
              radioButtons(
                ...
                label = "Treatment",
                choices = c("Ballooning" , "Stenting" ),
                selected = ifelse(is.null(hold$Intervention8_treat_culn1), character(0), hold$Intervention8_treat_culn1)
              )
            ),
            column(
              width = 2,
          ...
          fluidRow(
            column(
              ...
              radioButtons(
                ...
                label = "Treatment",
                choices = c("Ballooning" , "Stenting" ),
                selected = ifelse(is.null(hold$Intervention9_treat_culn1), character(0), hold$Intervention9_treat_culn1)
              )
            ),
            column(
              width = 2,
          ...
          fluidRow(
            column(
              ...
              radioButtons(
                ...
                label = "Treatment",
                choices = c("Ballooning" , "Stenting" ),
                selected = ifelse(is.null(hold$Intervention10_treat_culn1), character(0), hold$Intervention10_treat_culn1)
              )
            ),
            column(
              width = 2,
        ...
        fluidRow(
          column(
            ...
            radioButtons(
              ...
              choices = c("Yes", "No"),
              selected = ifelse(is.null(hold), character(0), hold$Intervention_ab_culn1),
              inline = TRUE,
            )
          ),
          conditionalPanel(
            "input.Intervention_ab_culn1 == 'Yes'",
            ns = ns,
            column(
              width = 3,
              textInput(
                ...
                label = "Diameter",
                value = hold$Intervention_ab_diameter_culn1
              )
            ),
            column(
              width = 3,
              textInput(
                ...
                label = "Length",
                value = hold$Intervention_ab_length_culn1
              )
            ),
            column(
              width = 3,
              textInput(
                ...
                label = "Max Pressure",
                value = hold$Intervention_ab_pressure_culn1
              )
            )
          )
        ),
        ...
        conditionalPanel(
          "input.Intervention_cl_culn1 == 'No'",
          ns = ns,
          fluidRow(
            column(
              width = 3,
          ...
          fluidRow(
            column(
              ...
              radioButtons(
                ...
                label = "Other",
                choices = c("Yes", "No"),
                selected = ifelse(is.null(hold), character(0), hold$Intervention_O_culn1),
                inline = TRUE
              )
            ),
            column(
