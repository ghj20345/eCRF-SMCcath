...
create_rct_query <- "CREATE TABLE rct (
  ...
  Cl_adm                          TEXT,
  hCG_adm                         TEXT,
  after1d_Date_adm                DATE,
  BUN_after1d_adm                 TEXT,
  Cr_after1d_adm                  TEXT,
  FG_after1d_adm                  TEXT,
  after2d_Date_adm                DATE,
  BUN_after2d_adm                 TEXT,
  Cr_after2d_adm                  TEXT,
  FG_after2d_adm                  TEXT,
  after3d_Date_adm                DATE,
  BUN_after3d_adm                 TEXT,
  Cr_after3d_adm                  TEXT,
  FG_after3d_adm                  TEXT,
  BCK_adm                         TEXT,
  PCK_adm                         TEXT,
  ...
  Prasugrel_adm	              		TEXT,
  Prasugrel_dose_adm              TEXT,
  Ticagrelor_adm	             		TEXT,
  Ticagrelor_dose_adm             TEXT,
  Nicorandil_adm                  TEXT,
  Nicorandil_dose_adm             TEXT,
  Wafarin_adm                     TEXT,
  Wafarin_dose_adm                TEXT,
  NOAC_adm                        TEXT,
  NOAC_name_adm                   TEXT,
  NOAC_dose_adm                   TEXT,
  BB_adm		                   		TEXT,
  ...
  ACE_dose_adm                    TEXT,
  Nitrate_adm	                 		TEXT,
  Nitrate_name_adm                TEXT,
  Nitrate_dose_adm                TEXT,
  Calcium_adm	                 		TEXT,
  Calcium_name_adm                TEXT,
  Calcium_dose_adm                TEXT,
  Trimetazidine_adm            		TEXT,
  Trimetazidine_dose_adm          TEXT,
  Insulin_adm                     TEXT,
  Insulin_dose_adm                TEXT,
  Entresto_adm	                 	TEXT,
  Entresto_name_adm               TEXT,
  Entresto_dose_adm               TEXT,
  Echo_Date_adm                   DATE,
  LVIDs_adm                       TEXT,
  LVEDV_adm                       TEXT,
  LVESV_adm                       TEXT,
  ...
  Prasugrel_out	              		TEXT,
  Prasugrel_dose_out	            TEXT,
  Ticagrelor_out	             		TEXT,
  Ticagrelor_dose_out	            TEXT,
  Nicorandil_out                  TEXT,
  Nicorandil_dose_out             TEXT,
  Wafarin_out                     TEXT,
  Wafarin_dose_out                TEXT,
  NOAC_out                        TEXT,
  NOAC_name_out                   TEXT,
  NOAC_dose_out                   TEXT,
  BB_out		                   		TEXT,
  ...
  ACE_dose_out                    TEXT,
  Nitrate_out	                 		TEXT,
  Nitrate_name_out                TEXT,
  Nitrate_dose_out                TEXT,
  Calcium_out	                 		TEXT,
  Calcium_name_out                TEXT,
  Calcium_dose_out                TEXT,
  Trimetazidine_out            		TEXT,
  Trimetazidine_dose_out          TEXT,
  Insulin_out                     TEXT,
  Insulin_dose_out                TEXT,
  Entresto_out	                 	TEXT,
  Entresto_name_out               TEXT,
  Entresto_dose_out               TEXT,
  ...
  Clopidogrel_M1	             		TEXT,
  Prasugrel_M1	              		TEXT,
  Prasugrel_dose_M1	            TEXT,
  Ticagrelor_M1	             		TEXT,
  Ticagrelor_dose_M1	            TEXT,
  Nicorandil_M1                  TEXT,
  Nicorandil_dose_M1             TEXT,
  Wafarin_M1                     TEXT,
  Wafarin_dose_M1                TEXT, 
  NOAC_M1                        TEXT,
  NOAC_name_M1                   TEXT,
  NOAC_dose_M1                   TEXT,
  BB_M1		                   		TEXT,
  ...
  ACE_dose_M1                    TEXT,
  Nitrate_M1	                 		TEXT,
  Nitrate_name_M1                TEXT,
  Nitrate_dose_M1                TEXT,
  Calcium_M1	                 		TEXT,
  Calcium_name_M1                TEXT,
  Calcium_dose_M1                TEXT,
  Trimetazidine_M1            		TEXT,
  Trimetazidine_dose_M1          TEXT,
  Insulin_M1                     TEXT,
  Insulin_dose_M1                TEXT,
  Entresto_M1	                 	TEXT,
  Entresto_name_M1               TEXT,
  Entresto_dose_M1               TEXT,
 ...
 -- M3 --
  ...
  Clopidogrel_M3	             		TEXT,
  Prasugrel_M3	              		TEXT,
  Prasugrel_dose_M3	            TEXT,
  Ticagrelor_M3	             		TEXT,
  Ticagrelor_dose_M3	            TEXT,
  Nicorandil_M3                  TEXT,
  Nicorandil_dose_M3             TEXT,
  Wafarin_M3                     TEXT,
  Wafarin_dose_M3                TEXT, 
  NOAC_M3                        TEXT,
  NOAC_name_M3                   TEXT,
  NOAC_dose_M3                   TEXT,
  BB_M3		                   		TEXT,
  ...
  ACE_dose_M3                    TEXT,
  Nitrate_M3	                 		TEXT,
  Nitrate_name_M3                TEXT,
  Nitrate_dose_M3                TEXT,
  Calcium_M3	                 		TEXT,
  Calcium_name_M3                TEXT,
  Calcium_dose_M3                TEXT,
  Trimetazidine_M3            		TEXT,
  Trimetazidine_dose_M3          TEXT,
  Insulin_M3                     TEXT,
  Insulin_dose_M3                TEXT,
  Entresto_M3	                 	TEXT,
  Entresto_name_M3               TEXT,
  Entresto_dose_M3               TEXT,
 ...
 -- M6 --
  ...
  Clopidogrel_M6	             		TEXT,
  Prasugrel_M6	              		TEXT,
  Prasugrel_dose_M6	            TEXT,
  Ticagrelor_M6	             		TEXT,
  Ticagrelor_dose_M6	            TEXT,
  Nicorandil_M6                  TEXT,
  Nicorandil_dose_M6             TEXT,
  Wafarin_M6                     TEXT,
  Wafarin_dose_M6                TEXT, 
  NOAC_M6                        TEXT,
  NOAC_name_M6                   TEXT,
  NOAC_dose_M6                   TEXT,
  BB_M6		                   		TEXT,
  ...
  ACE_dose_M6                    TEXT,
  Nitrate_M6	                 		TEXT,
  Nitrate_name_M6                TEXT,
  Nitrate_dose_M6                TEXT,
  Calcium_M6	                 		TEXT,
  Calcium_name_M6                TEXT,
  Calcium_dose_M6                TEXT,
  Trimetazidine_M6            		TEXT,
  Trimetazidine_dose_M6          TEXT,
  Insulin_M6                     TEXT,
  Insulin_dose_M6                TEXT,
  Entresto_M6	                 	TEXT,
  Entresto_name_M6               TEXT,
  Entresto_dose_M6               TEXT,
  
  CMR_Date_after2d               DATE,
  ...
  Clopidogrel_Mf	             		TEXT,
  Prasugrel_Mf	              		TEXT,
  Prasugrel_dose_Mf	            TEXT,
  Ticagrelor_Mf	             		TEXT,
  Ticagrelor_dose_Mf	            TEXT,
  Nicorandil_Mf                  TEXT,
  Nicorandil_dose_Mf             TEXT,
  Wafarin_Mf                     TEXT,
  Wafarin_dose_Mf                TEXT, 
  NOAC_Mf                        TEXT,
  NOAC_name_Mf                   TEXT,
  NOAC_dose_Mf                   TEXT,
  BB_Mf		                   		TEXT,
  ...
  ACE_dose_Mf                    TEXT,
  Nitrate_Mf	                 		TEXT,
  Nitrate_name_Mf                TEXT,
  Nitrate_dose_Mf                TEXT,
  Calcium_Mf	                 		TEXT,
  Calcium_name_Mf                TEXT,
  Calcium_dose_Mf                TEXT,
  Trimetazidine_Mf            		TEXT,
  Trimetazidine_dose_Mf          TEXT,
  Insulin_Mf                     TEXT,
  Insulin_dose_Mf                TEXT,
  Entresto_Mf	                 	TEXT,
  Entresto_name_Mf               TEXT,
  Entresto_dose_Mf               TEXT,
